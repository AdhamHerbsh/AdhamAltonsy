  ...
  e.fn.meanmenu = function (n) {
    ...
    return this.each(function () {
      var e = n.meanMenuTarget,
        ...
        y = n.meanExpand,
        j = n.meanContract,
        Q = (n.meanPreview, n.meanRemoveAttrs),
        f = n.onePage,
        g = n.meanDisplay,
        p = n.removeElements,
        C = n.siteLogo,
      ...
      var x = "",
        ...
        A = !1,
        E = !1;
      "right" === u && (x = "right:" + l + ";left:auto;"),
        "left" === u && (x = "left:" + l + ";right:auto;"),
        P();
      var M = "",
        W = function () {
        ...
        S = function () {
          ...
          if (o >= t) {
            ...
            jQuery(".mean-nav").html(r),
              ...
              d
                ? v
                  ? (jQuery(".mean-nav ul ul:not(.preview-ul)").each(
                      function () {
                    ...
                    jQuery(".preview-ul").each(function () {
                      jQuery(this)
                        .parent()
                        .append(
                          '<a class="mean-expand fa-regular fa-circle-info" href="#" "></a>'
                        );
                    }),
                    jQuery(".mean-expand").on("click", function (e) {
                      e.preventDefault(),
                        jQuery(this).siblings(".preview-ul").length
